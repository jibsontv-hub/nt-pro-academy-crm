#!/usr/bin/env bash
# 🔬 PRE-PUSH-VERIFY — fährt lokalen Flask hoch, lässt alle 3 Sub-Agenten laufen,
...
echo "║  3 Sub-Agenten · QA · Journey · Vertrieb           ║"
echo "╚════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "┌─────────────────────────────────────────┐"
echo "│  🛡  AGENT 1/3 — QA-Audit (alle Routes) │"
echo "└─────────────────────────────────────────┘"
...
echo ""
echo "┌─────────────────────────────────────────┐"
echo "│  👤 AGENT 2/3 — Human-Walkthrough       │"
echo "└─────────────────────────────────────────┘"
...
echo ""
echo "┌─────────────────────────────────────────┐"
echo "│  🎯 AGENT 3/3 — Vertriebs-Pipeline      │"
echo "└─────────────────────────────────────────┘"
...
TOTAL=$((QA_RC + J_RC + V_RC))
if [ "$TOTAL" = "0" ]; then
    echo ""
    echo "🟢  ALLE 3 AGENTEN GRÜN — bereit zum Push."
    echo ""
    exit 0
else
    echo ""
